...
const LiveEditorComp = React.lazy(() => import('../../components/LiveEditor/LiveEditorComp'));
                    ...
                    <section>
                        <div className={classes.box}>
                            ...
                            <Suspense fallback={<h4 style={{margin: '3rem auto'}}>Loading live JSX editor...</h4>}>
                                <LiveEditorComp codeExample='simple' />
                            </Suspense>
                        </div>
                        ...
                        <div className={classes.box}>
                            ...
                            <Suspense fallback={<h4 style={{margin: '3rem auto'}}>Loading live JSX editor...</h4>}>
                                <LiveEditorComp codeExample='stateful' />
                            </Suspense>
                        </div>
                        ...
                        <div className={classes.box}>
                            ...
                            <Suspense fallback={<h4 style={{margin: '3rem auto'}}>Loading live JSX editor...</h4>}>
                                <LiveEditorComp codeExample='application' />
                            </Suspense>
                        </div>
                        ...
                        <div className={classes.box}>
                            ...
                            <Suspense fallback={<h4 style={{margin: '3rem auto'}}>Loading live JSX editor...</h4>}>
                                <LiveEditorComp codeExample='external' />
                            </Suspense>
                        </div>
                    </section>
                </main>
